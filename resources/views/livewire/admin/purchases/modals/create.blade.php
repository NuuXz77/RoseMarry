<div>
    <x-form.modal modalId="modal_create_purchase" title="Buat Purchase Baru" buttonText="Buat Purchase"
        buttonIcon="heroicon-o-plus" saveAction="save" saveButtonText="Simpan" saveButtonIcon="heroicon-o-check"
        modalSize="modal-box w-11/12 max-w-2xl" :showButton="true">
        ...
        <div x-data="{
            ...
            <div class="flex items-center gap-4 mb-4 bg-base-200/30 p-4 rounded-3xl border border-base-300/50">
                <div class="form-control">
                    <label class="label cursor-pointer gap-3">
                        ...
                        <input type="radio" name="supplier_type_create" class="radio radio-primary radio-sm"
                ...
                <div class="form-control">
                    <label class="label cursor-pointer gap-3">
                        ...
                        <input type="radio" name="supplier_type_create" class="radio radio-secondary radio-sm"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <x-form.input label="Nomor Invoice" name="invoice_number" wireModel="invoice_number" readonly
                    hint="Otomatis oleh sistem." :required="true" />
            </div>
            ...
            <div class="mt-8 pt-6 border-t border-base-300">
                ...
                <div class="bg-base-200/30 p-5 rounded-3xl border border-base-300/50">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-3 items-end">
                        ...
                        <div class="md:col-span-2">
                            <button type="button" @click="addItem()" class="btn btn-primary rounded-2xl shadow-lg shadow-primary/20 h-[52px]">
